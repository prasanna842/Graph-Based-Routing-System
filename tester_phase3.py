...
for query_id in range(1,no_of_queries+1):
    ...
    for j in range(num_queries):
        ...
        sub_queries.append({"order_id":j,"pickup":s,"dropoff":t})

    del_guys = random.randint(50,node_id)
    depot=random.randint(1,node_id)

    queries.append({"orders":sub_queries,"fleet":{"num_delievery_guys":del_guys,"depot_node":depot}})
